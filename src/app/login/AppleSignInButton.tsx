...
import { T } from "../T";
import { loginWithApple } from "./actions";

// Unlike Google, Apple allows its OAuth page inside an embedded WebView, so the native app runs
// this exact in-app flow — no system-browser hop and no deep-link handoff to go wrong (see
// GoogleSignInButton.tsx for why Google needs all of that). Black-on-white with the Apple mark is
// the presentation Apple's own Sign in with Apple guidelines ask for.
