  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 p-4 pb-24">
      ...
      <div className="flex flex-col gap-5 rounded-3xl border border-brand-200/70 bg-white p-5 text-sm leading-relaxed text-zinc-700 dark:border-brand-800/50 dark:bg-zinc-900 dark:text-zinc-300">
        <p>
          Roun is a private journal for families to record their children&apos;s and pets&apos; lives. This page
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold text-brand-800 dark:text-brand-200">How we use it</h2>
          <p>
            We use this information only to run Roun for your family: showing your journal back to you, notifying
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold text-brand-800 dark:text-brand-200">Who can see it</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold text-brand-800 dark:text-brand-200">About children&apos;s (and pets&apos;) data</h2>
          <p>
            Roun is a journal <em>about</em> children and pets, kept by their family. None of them create their own
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold text-brand-800 dark:text-brand-200">Cookies</h2>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-heading font-semibold text-brand-800 dark:text-brand-200">Changes to this policy</h2>
          <p>
            If this policy changes in a meaningful way, we&apos;ll update the date at the top of this page. Continued
            use of Roun after a change means you accept the update.
          </p>
        </section>
