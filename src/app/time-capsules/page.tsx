  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 p-4 pb-24">
      <header className="pt-4">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">Write a message today that opens on a future date.</p>
      </header>
      <CapsuleForm />

      <div className="flex flex-col gap-3">
        {capsules.length === 0 && (
          <p className="text-center text-sm text-zinc-600 dark:text-zinc-400">No messages yet.</p>
        )}
