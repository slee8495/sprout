...
const ko: Record<string, string> = {
  ...
  "Free plan": "무료 플랜",
  "Free trial — ends {date}": "무료 체험 — {date} 종료",
  ...
  "What you get with Roun Pro": "Roun Pro로 받는 것",
  "Unlimited kids and pets — the free plan covers one": "아이·반려동물 무제한 — 무료 플랜은 1명",
  "5GB of photo and video storage — the free plan has 1GB": "사진·동영상 저장공간 5GB — 무료 플랜은 1GB",
  "No ads": "광고 없음",
  "{price} per year": "연 {price}",
  "{price} per month": "월 {price}",
  "Payment is charged to your Apple Account at confirmation of purchase. It renews automatically unless you turn off auto-renew at least 24 hours before the period ends, and you can manage or cancel it in Settings → Apple Account → Subscriptions.": "구매를 확인하면 Apple 계정으로 결제됩니다. 기간 종료 24시간 전까지 자동 갱신을 끄지 않으면 자동으로 갱신되며, 설정 → Apple 계정 → 구독에서 관리하거나 해지할 수 있어요.",
  "Payment is charged to your Google Play account at confirmation of purchase. It renews automatically unless you cancel at least 24 hours before the period ends, and you can manage or cancel it in Google Play → Subscriptions.": "구매를 확인하면 Google Play 계정으로 결제됩니다. 기간 종료 24시간 전까지 해지하지 않으면 자동으로 갱신되며, Google Play → 구독에서 관리하거나 해지할 수 있어요.",
  "Terms of Use": "이용약관",
  "Loading plans…": "요금제 불러오는 중…",
  "Plans aren't available right now. Please try again later.": "지금은 요금제를 불러올 수 없어요. 잠시 후 다시 시도해주세요.",
  "That purchase didn't go through. Nothing was charged — try again.": "결제가 완료되지 않았어요. 청구된 금액은 없습니다 — 다시 시도해주세요.",
  "No previous purchase found on this account.": "이 계정에서 이전 구매 내역을 찾지 못했어요.",
  "Couldn't check for previous purchases — try again.": "이전 구매를 확인하지 못했어요 — 다시 시도해주세요.",
  "Manage or cancel this subscription in Settings → Apple Account → Subscriptions.": "설정 → Apple 계정 → 구독에서 관리하거나 해지할 수 있어요.",
  "Manage or cancel this subscription in Google Play → Subscriptions.": "Google Play → 구독에서 관리하거나 해지할 수 있어요.",
  "No date": "날짜 없음",
...
const zh: Record<string, string> = {
  ...
  "Free plan": "免费套餐",
  "Free trial — ends {date}": "免费试用 — {date} 结束",
  ...
  "What you get with Roun Pro": "Roun Pro 包含的内容",
  "Unlimited kids and pets — the free plan covers one": "孩子和宠物不限数量 — 免费套餐仅限 1 个",
  "5GB of photo and video storage — the free plan has 1GB": "5GB 照片和视频存储空间 — 免费套餐为 1GB",
  "No ads": "无广告",
  "{price} per year": "每年 {price}",
  "{price} per month": "每月 {price}",
  "Payment is charged to your Apple Account at confirmation of purchase. It renews automatically unless you turn off auto-renew at least 24 hours before the period ends, and you can manage or cancel it in Settings → Apple Account → Subscriptions.": "确认购买后将从你的 Apple 账户扣款。除非在当前周期结束前至少 24 小时关闭自动续订，否则将自动续订；你可以在“设置 → Apple 账户 → 订阅”中管理或取消。",
  "Payment is charged to your Google Play account at confirmation of purchase. It renews automatically unless you cancel at least 24 hours before the period ends, and you can manage or cancel it in Google Play → Subscriptions.": "确认购买后将从你的 Google Play 账户扣款。除非在当前周期结束前至少 24 小时取消，否则将自动续订；你可以在 Google Play → 订阅中管理或取消。",
  "Terms of Use": "使用条款",
  "Loading plans…": "正在加载方案…",
  "Plans aren't available right now. Please try again later.": "暂时无法加载方案，请稍后再试。",
  "That purchase didn't go through. Nothing was charged — try again.": "购买未完成，未产生任何扣款 — 请重试。",
  "No previous purchase found on this account.": "在此账户上未找到以前的购买记录。",
  "Couldn't check for previous purchases — try again.": "无法查询以前的购买记录 — 请重试。",
  "Manage or cancel this subscription in Settings → Apple Account → Subscriptions.": "可在「设置 → Apple 账户 → 订阅」中管理或取消。",
  "Manage or cancel this subscription in Google Play → Subscriptions.": "可在 Google Play → 订阅中管理或取消。",
  "No date": "无日期",
...
const ja: Record<string, string> = {
  ...
  "⬇️ Download PDF": "⬇️ PDFをダウンロード",
  From: "開始日",
  To: "終了日",
  Clear: "クリア",
  "Preparing PDF…": "PDFを準備中…",
  ...
  "What you get with Roun Pro": "Roun Pro でできること",
  "Unlimited kids and pets — the free plan covers one": "子供・ペットは無制限 — 無料プランは1人まで",
  "5GB of photo and video storage — the free plan has 1GB": "写真・動画のストレージ5GB — 無料プランは1GB",
  "No ads": "広告なし",
  "{price} per year": "年額 {price}",
  "{price} per month": "月額 {price}",
  "Payment is charged to your Apple Account at confirmation of purchase. It renews automatically unless you turn off auto-renew at least 24 hours before the period ends, and you can manage or cancel it in Settings → Apple Account → Subscriptions.": "購入を確定すると Apple アカウントに請求されます。期間終了の24時間前までに自動更新をオフにしない限り自動的に更新され、「設定 → Apple アカウント → サブスクリプション」で管理・解約できます。",
  "Payment is charged to your Google Play account at confirmation of purchase. It renews automatically unless you cancel at least 24 hours before the period ends, and you can manage or cancel it in Google Play → Subscriptions.": "購入を確定すると Google Play アカウントに請求されます。期間終了の24時間前までに解約しない限り自動的に更新され、Google Play → 定期購入で管理・解約できます。",
  "Terms of Use": "利用規約",
  "Loading plans…": "プランを読み込み中…",
  "Plans aren't available right now. Please try again later.": "現在プランを読み込めません。しばらくしてからお試しください。",
  "That purchase didn't go through. Nothing was charged — try again.": "購入が完了しませんでした。請求は発生していません — もう一度お試しください。",
  "No previous purchase found on this account.": "このアカウントに以前の購入は見つかりませんでした。",
  "Couldn't check for previous purchases — try again.": "以前の購入を確認できませんでした — もう一度お試しください。",
  "Manage or cancel this subscription in Settings → Apple Account → Subscriptions.": "「設定 → Apple アカウント → サブスクリプション」から管理・解約できます。",
  "Manage or cancel this subscription in Google Play → Subscriptions.": "Google Play → 定期購入から管理・解約できます。",
  "No date": "日付なし",
...
const es: Record<string, string> = {
  ...
  "Free trial — ends {date}": "Prueba gratuita — termina el {date}",
  ...
  "⬇️ Download PDF": "⬇️ Descargar PDF",
  From: "Desde",
  To: "Hasta",
  Clear: "Borrar",
  ...
  "What you get with Roun Pro": "Qué incluye Roun Pro",
  "Unlimited kids and pets — the free plan covers one": "Hijos y mascotas ilimitados — el plan gratuito incluye uno",
  "5GB of photo and video storage — the free plan has 1GB": "5GB de almacenamiento de fotos y videos — el plan gratuito tiene 1GB",
  "No ads": "Sin anuncios",
  "{price} per year": "{price} al año",
  "{price} per month": "{price} al mes",
  "Payment is charged to your Apple Account at confirmation of purchase. It renews automatically unless you turn off auto-renew at least 24 hours before the period ends, and you can manage or cancel it in Settings → Apple Account → Subscriptions.": "El pago se carga a tu cuenta de Apple al confirmar la compra. Se renueva automáticamente a menos que desactives la renovación al menos 24 horas antes de que termine el periodo, y puedes gestionarla o cancelarla en Ajustes → Cuenta de Apple → Suscripciones.",
  "Payment is charged to your Google Play account at confirmation of purchase. It renews automatically unless you cancel at least 24 hours before the period ends, and you can manage or cancel it in Google Play → Subscriptions.": "El pago se carga a tu cuenta de Google Play al confirmar la compra. Se renueva automáticamente a menos que canceles al menos 24 horas antes de que termine el periodo, y puedes gestionarla o cancelarla en Google Play → Suscripciones.",
  "Terms of Use": "Términos de uso",
  "Loading plans…": "Cargando planes…",
  "Plans aren't available right now. Please try again later.": "Los planes no están disponibles ahora. Inténtalo más tarde.",
  "That purchase didn't go through. Nothing was charged — try again.": "La compra no se completó. No se cobró nada: inténtalo de nuevo.",
  "No previous purchase found on this account.": "No se encontraron compras anteriores en esta cuenta.",
  "Couldn't check for previous purchases — try again.": "No se pudieron comprobar las compras anteriores: inténtalo de nuevo.",
  "Manage or cancel this subscription in Settings → Apple Account → Subscriptions.": "Gestiona o cancela esta suscripción en Ajustes → Cuenta de Apple → Suscripciones.",
  "Manage or cancel this subscription in Google Play → Subscriptions.": "Gestiona o cancela esta suscripción en Google Play → Suscripciones.",
  "No date": "Sin fecha",
